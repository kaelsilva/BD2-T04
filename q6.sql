...
DROP VIEW IF EXISTS funcionarios_salario_oculto;
...
CREATE USER 'empresa_supervisor'@'localhost' IDENTIFIED BY 'password';

GRANT SELECT ON EmpresaDB.funcionarios_salario_oculto TO 'empresa_supervisor'@'localhost';
